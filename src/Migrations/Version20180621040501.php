 ...
 */
final class Version20180621040501 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__customers_tickets AS SELECT id, ticket_id, solded_at, reserved_at, customer FROM customers_tickets');
        ...
        $this->addSql('INSERT INTO customers_tickets (id, ticket_id, solded_at, reserved_at, customer_id) SELECT id, ticket_id, solded_at, reserved_at, customer FROM __temp__customers_tickets');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO customers_tickets (id, ticket_id, solded_at, reserved_at, customer) SELECT id, ticket_id, solded_at, reserved_at, customer_id FROM __temp__customers_tickets');
        $this->addSql('DROP TABLE __temp__customers_tickets');
        $this->addSql('CREATE INDEX IDX_680E4E11700047D2 ON customers_tickets (ticket_id)');
        $this->addSql('DROP INDEX IDX_6C3BF144D70E4479');
        $this->addSql('CREATE TEMPORARY TABLE __temp__shows AS SELECT id, theater_id, title, artist, date, description, url, image, close FROM shows');
